...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error while fetching phone from database"})
			return
		}
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refreshToken, _ := helper.GenerateAllTokens(foundUser.Email, foundUser.First_name, foundUser.Last_name, foundUser.Phone, foundUser.User_id, foundUser.User_type)
